...
| [curios/](../../src/data/curios/) | 房间物件的唯一数据入口：A1-A5、B1-B3、C1-C3、安全投递柜与流浪货商；`critters.ts` 维护三种机械小生物的双食品，`rewardPools.ts` 维护材料/换金物/水晶/食品/消耗品/模组池，`merchantPricing.ts` 维护六格货架价格。 |
