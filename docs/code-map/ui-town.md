...
| [StationLayer/](../../src/ui/town/TownScreen/StationLayer/StationLayer.tsx) | 全景上的建筑热区与悬停效果。 |
| [StationHud/](../../src/ui/town/TownScreen/StationHud/StationHud.tsx) | 左上角的据点终端：生存日刻度盘、居民积分和三色水晶、队伍状态（上阵 / 在编 / 疗养 / 净化 / 阵亡）。 |
| [StationDock/](../../src/ui/town/TownScreen/StationDock/StationDock.tsx) | 右下角的编队和出击按钮。它们不算设施，点击后直接切到顶层全屏页。 |
| [StationBot/](../../src/ui/town/TownScreen/StationBot/StationBot.tsx) / [StationSettings/](../../src/ui/town/TownScreen/StationSettings/StationSettingsPanel.tsx) + [SettingsGearButton/](../../src/ui/town/TownScreen/SettingsGearButton/SettingsGearButton.tsx) | 据点机器人的台词气泡；系统菜单（音频设置、重置存档）。 |
| [FacilityBack/](../../src/ui/town/TownScreen/FacilityBack/FacilityBack.tsx) | 设施内通用的返回按钮。 |
| [facilityScenes.ts](../../src/ui/town/facilityScenes.ts) / [facilityExit.tsx](../../src/ui/town/facilityExit.tsx) / [townReturn.ts](../../src/ui/town/townReturn.ts) | 进入设施的演出预设（时长的唯一来源）；关闭设施时等待面板收起；从顶层页返回据点时补播反向换场的一次性标记。 |
...
| 文件 | 作用 |
| --- | --- |
| [useSquadTalent.ts](../../src/ui/town/training/useSquadTalent.ts) | 小队徽章和天赋树的交互层。所有判定都来自 `data/squadTalents.ts` 的纯函数。 |
...
一级全屏页（`screen === "sortie"`），分两步：选地图，再准备物资。状态在 `store/sortieStore`，不会持久化。

| 目录 | 作用 |
| --- | --- |
| [SortieScreen/](../../src/ui/sortie/SortieScreen/SortieScreen.tsx) + [SortieStepViewport/](../../src/ui/sortie/SortieStepViewport/SortieStepViewport.tsx) + [sortieStepTransition.ts](../../src/ui/sortie/sortieStepTransition.ts) | 页面根组件和两个步骤之间的切换演出。 |
