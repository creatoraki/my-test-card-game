...
路径：`src/ui/explore/`。房间制探索的界面，包括横向场景、小地图、底部 HUD 和各类浮层。会话数据来自 `store/exploreStore`，场景内的操作通过 `runStore`（见 `store/exploreCorridor.ts`、`store/curioActions.ts`）派发。
...
| [ExploreDock.tsx](../../src/ui/explore/ExploreScreen/ExploreDock.tsx) / [ExploreInventory.tsx](../../src/ui/explore/ExploreScreen/ExploreInventory.tsx) + [useExploreInventory.ts](../../src/ui/explore/ExploreScreen/useExploreInventory.ts) | 底部 HUD；背包相关的状态与操作（使用、丢弃、寄回、为目标选择角色）。 |
| [CurioPanel.tsx](../../src/ui/explore/ExploreScreen/CurioPanel.tsx) + [curioTheme.ts](../../src/ui/explore/ExploreScreen/curioTheme.ts) + [useCurioLoot.ts](../../src/ui/explore/ExploreScreen/useCurioLoot.ts) | 物件交互面板：选择决策和执行者、查看结算结果、领取物品。配色按物件分类取。 |
| [BossGatePanel.tsx](../../src/ui/explore/ExploreScreen/BossGatePanel.tsx) | BOSS 红门的确认面板：开启后无法返回副本。 |
| [RelicRail.tsx](../../src/ui/explore/ExploreScreen/RelicRail.tsx) | 探索页的遗物栏。 |
...
| [CorridorBackdrop/](../../src/ui/explore/CorridorScene/CorridorBackdrop/CorridorBackdrop.tsx) / [EcoArkArchitecture/](../../src/ui/explore/CorridorScene/EcoArkArchitecture/EcoArkArchitecture.tsx) | 远景和近景图层；生态方舟专用的建筑层。 |
| [CorridorPlayer/](../../src/ui/explore/CorridorScene/CorridorPlayer/CorridorPlayer.tsx) | 探索角色的逐帧动画和动作状态。 |
| [CorridorSprite.tsx](../../src/ui/explore/CorridorScene/CorridorSprite.tsx) / [RoomPortal.tsx](../../src/ui/explore/CorridorScene/RoomPortal.tsx) / [BossGate.tsx](../../src/ui/explore/CorridorScene/BossGate.tsx) / [ShadowEncounter.tsx](../../src/ui/explore/CorridorScene/ShadowEncounter.tsx) | 场景中的物件、传送门（四座外观完全相同）、BOSS 红门、黑影。 |
| [PlayerSpeech/](../../src/ui/explore/CorridorScene/PlayerSpeech/PlayerSpeech.tsx) + [useExplorerChatter.ts](../../src/ui/explore/CorridorScene/useExplorerChatter.ts) | 探索者头顶的独白气泡，文案来自 `data/explorerLines.ts`。 |
...
- [eventKindLabel.ts](../../src/ui/explore/eventKindLabel.ts)：旧节点事件类型的中文名，目前只有结算页的 `EventDropBand` 在用。
