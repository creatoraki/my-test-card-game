...
import { beginCorridorEncounter, buildRoomScene, canWalkCorridor, openForcedCurio, portalAt } from "../corridor/corridorSession";
...
import { roomMoveCost } from "../resources/energyCost";
import { canUseBeacon } from "../relics/relicModifiers";
