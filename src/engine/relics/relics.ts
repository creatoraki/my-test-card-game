...
import type { EffectResolution } from "../effects/effects";
import { resolveEffects } from "../effects/effects";
import { withHitRecorder } from "../core/animHits";
import { checkEnd, ops } from "../core/ops";
import { currentRecorder, ensureCardFxSnapshot, recordRelicTrigger, snapshotHp } from "../cards/cardFx";
import { MAX_RELIC_DEPTH } from "./types";
