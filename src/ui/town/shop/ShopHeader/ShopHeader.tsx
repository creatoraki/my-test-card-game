...
interface Props { title: string; subtitle?: string; credits: number; level: number; onBack?: () => void }

export function ShopHeader({ title, subtitle = "精选星际物资，强化你的旅程。", credits, level, onBack }: Props) {
  return (
