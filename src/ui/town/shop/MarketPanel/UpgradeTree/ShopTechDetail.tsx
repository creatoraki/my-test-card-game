...
export function ShopTechDetail({ selectedId, doneTechs, loot, storage, onResearch }: Props) {
  ...
  const state = shopTechState(tech, doneTechs, loot, storage);
        ...
        <div className={s.materials}>
          {check.materials.map((material) => {
            const stack: ItemStack = {
              uid: `shop-detail-${material.itemId}`,
