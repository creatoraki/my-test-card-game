      ...
      <svg className={s.frame} viewBox="0 0 198 72" fill="none" aria-hidden="true">
        <defs>
          <linearGradient id={`${id}-body`} x2=".8" y2="1">
            <stop stopColor="#153d46" stopOpacity=".94" />
            <stop offset=".5" stopColor="#06151c" stopOpacity=".97" />
            <stop offset="1" stopColor="#102b35" stopOpacity=".95" />
          </linearGradient>
          <linearGradient id={`${id}-edge`}>
            <stop stopColor="#7ffff7" /><stop offset=".45" stopColor="#27929d" />
            <stop offset=".8" stopColor="#b7ffff" /><stop offset="1" stopColor="#40bdcf" />
          </linearGradient>
          <pattern id={`${id}-grid`} width="7" height="7" patternUnits="userSpaceOnUse">
            <path d="M0 0h7v7" stroke="#79d9de" strokeWidth=".4" opacity=".12" />
          </pattern>
        ...
        <path d="m43 25-11 10 11 10m-13-20L19 35l11 10" stroke="#6ffff9" strokeWidth="3" strokeLinejoin="miter" transform="translate(5 0)" />
      </svg>
