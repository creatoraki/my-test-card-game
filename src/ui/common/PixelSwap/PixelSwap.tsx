...
import s from './PixelSwap.module.css';
...
function PixelSwap({
  ...
  useEffect(() => {
    ...
    frozenGrid.pixels.forEach((pixel, index) => {
      ...
      content.className = s['pixel-swap__pixel-content'];
  ...
  return (
    <div
      ref={containerRef}
      className={cx(s['pixel-swap'], className)}
    ...
    >
      ...
      {transition && (
        <div className={s['pixel-swap__grid']} aria-hidden="true">
