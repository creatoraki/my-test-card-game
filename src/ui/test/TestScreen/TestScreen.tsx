...
import { AstraSceneDemo } from "@/ui/test/astra/AstraSceneDemo";
...
type TestTab = "opus" | "ds" | "qwen" | "luna" | "astra";

const TABS: TestTab[] = ["opus", "ds", "qwen", "luna", "astra"];
  ...
  return (
    <main className={s.root}>
      ...
      <section className={s.page} key={activeTab} aria-label={`${activeTab} 测试页面`}>
        ...
        {activeTab === "astra" ? <AstraSceneDemo /> : null}
      </section>
    </main>
  );
}
