...
import { QwenRouteBoard, QWEN_GENERATE_MS, QWEN_PANEL_W, QWEN_PANEL_H } from "./QwenRouteBoard";
import { makeMockBoard } from "./qwenRouteMock";
import s from "./QwenRoutePanel.module.css";

export function QwenRoutePanel() {
  ...
  useEffect(() => {
    ...
    const id = window.setTimeout(() => setGenerating(false), QWEN_GENERATE_MS);
  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.stage} style={{ width: QWEN_PANEL_W, height: QWEN_PANEL_H }}>
        <QwenRouteBoard
          key={`${seed}-${runKey}`}
          board={current}
