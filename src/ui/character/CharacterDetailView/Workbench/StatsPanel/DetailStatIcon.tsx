...
const icons: Partial<Record<keyof StatBlock, ReactNode>> = {
  ...
  fastMastery: <path d="m12 5 10 11-10 11M20 5l10 11-10 11M2 11h6M1 16h7M2 21h6" />,
  executeMastery: <><path d="M5 29 25 9m-3-4 7 7m-10-4 7 7" /><path d="M3 4h11v5H3Z" /><path d="M3 4h5v5H3Z" fill="currentColor" stroke="none" /></>,
  chargeMastery: <><path d="M3 18h20m-7-8 8 8-8 8" /><path d="M4 5h24v4H4Z" fill="currentColor" stroke="none" /></>,
