...
const ACCENTS = "M5 158V22L22 5H114 M183 5H245 M369 5l14 14h38 M429 48v136 M5 354v52l17-20v-75 M429 529l-53 53h-36 M429 686v59l-22 22h-67 M103 767H22L5 750v-87";
...
export const FigureFrame = memo(function FigureFrame() {
  ...
  return (
    <svg className={s.frame} viewBox="0 0 434 772" preserveAspectRatio="none" fill="none" aria-hidden="true">
      ...
      <path d="M50 33h66M322 538h52M26 693v23M363 27h40" stroke="#b9d5ff" strokeWidth="2" />
