...
interface Props {
  ...
  selected: boolean;
  variant?: "hand" | "pile";
  leaving?: boolean; // true: 出牌/丢弃后向上出鞘渐隐(见 HandCard.motion.module.css)
...
export const HandCard = memo(function HandCard({
  ...
  return (
    ...
    //     (.hand-slot:hover::after, 见 HandCard.motion.module.css)补上命中区, 故移到弹起的卡上也不会掉焦。
    //   ⚠ 尺寸/负 margin 叠压/张数自适应等版式规则全部认这一层, 见 HandCard.layout.module.css 与 HandTray.module.css。
    <div
      className={cx(
        s["hand-slot"],
