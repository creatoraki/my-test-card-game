...
import { ASSEMBLE_MODULE_LETTERS, assembleModuleItemId, MODULE_ITEM_DEFS } from "../items/catalog/modules";
import { itemRegionId, regionalMaterial } from "../items/catalog/regional";
