...
export const SWORDSMAN_CARD_DEFS: CardDef[] = [
  {
    ...
    rarity: "common",
    anim: "ice",
    effects: [{ type: "DAMAGE", multiplier: 0.9, target: "primary", hitBonus: 10 }],
  ...
  },
  {
    ...
    rarity: "common",
    anim: "buff",
    effects: [{ type: "APPLY_STATUS", status: "sharp", stacks: 1, duration: 3, target: "primary" }],
    text: "为一名队友附加持续 3 回合的锋利。",
  },
  {
    id: "mirage",
    name: "幻陇",
  ...
  },
  {
    ...
    rarity: "common",
    anim: "slash",
    effects: [{ type: "DAMAGE", multiplier: 0.8, target: "allFoes" }],
    ...
    effects: [
      {
        type: "DAMAGE",
        multiplier: 0.7,
        damageBonus: { when: "targetHasShield", multiplier: 0.5 },
        target: "primary",
      },
    ],
    text: "造成 {0} 点伤害。目标有护盾时，伤害倍率 +50%。",
  },
  {
    id: "zanshin",
    name: "残心",
  ...
  },
  {
    ...
    anim: "ice",
    effects: [
      { type: "DAMAGE", multiplier: 1.0, target: "allFoes" },
      { type: "DISCARD", discardPick: "handAll" },
      { type: "APPLY_STATUS", status: "sharp", stacks: 1, duration: 3, target: "self" },
    ],
    text: "对所有敌人造成 {0} 点伤害，然后丢弃所有手牌，并获得持续 3 回合的锋利。",
  },
  {
    id: "divine-eye",
    name: "天眼通",
  ...
  },
  {
    ...
    onDiscard: {
      mode: "custom",
      effects: [{ type: "ADD_CARD_TO_HAND", cardId: "demon-edge-second" }],
    },
    text: "造成 {0} 点伤害。被丢弃时，将一张魔宗二刃加入手牌。",
  },
  {
    id: "demon-edge-second",
    name: "魔宗二刃",
    ownerCharId: "swordsman",
    cost: 2,
    cardType: "normal",
    ...
    exhaust: true,
    anim: "slash",
    effects: [{ type: "DAMAGE", multiplier: 1.4, target: "primary" }],
    text: "造成 {0} 点伤害。打出后消耗。",
  },
  {
    id: "crane-dance",
    ...
    effects: [
      { type: "GAIN_SHIELD", multiplier: 0.4, target: "primary" },
      {
        ...
        multiplier: 0.4,
        target: "self",
        condition: "fastCardsInHandAtLeast",
        conditionValue: 3,
      },
    ],
    text: "为一名队友获得 {0} 点护盾；手牌中速攻牌超过 2 张时，自身也获得 {1} 点护盾。",
  },
  {
    id: "wolf-sparrow",
    name: "狼雀",
    ...
    rarity: "common",
    anim: "slash",
    effects: [{ type: "DAMAGE", multiplier: 1.2, lifesteal: 0.2, target: "primary" }],
    text: "造成 {0} 点伤害，并按实际造成伤害的 20% 回复自身生命。",
  },
];
