...
/** 首版只投放这八种物件。展示、效果和素材格位集中配置。 */
export const CORRIDOR_CURIOS: Record<CurioKind, CurioDefinition> = {
  chest: {
    name: "遗留物资箱", verb: "搜寻", sprite: 1, size: 205,
    event: {
  ...
  medical: {
    name: "应急医疗柜", verb: "检查", sprite: 2, size: 238,
    event: {
  ...
  terminal: {
    name: "破损数据终端", verb: "接入", sprite: 3, size: 220,
    event: {
  ...
  vending: {
    name: "故障售货机", verb: "翻找", sprite: 4, size: 240,
    event: {
  ...
  purifier: {
    name: "残存净化罐", verb: "回收", sprite: 5, size: 184,
    event: {
  ...
  scrap: {
    name: "废弃零件堆", verb: "搜刮", sprite: 6, size: 230,
    event: {
  ...
  dispatch: {
    name: "安全投递柜", verb: "启用", sprite: 7, size: 250,
    event: {
  ...
  camp: {
    name: "遗落营地", verb: "休整", sprite: 8, size: 215,
    event: {
