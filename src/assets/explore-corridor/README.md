...
- 旧版 `传送门.png`、`售货机.png`、`宝箱.png`、`雕像.png` 保留在目录中，不参与当前走廊运行时渲染。黑影与破地动画仍由 `ShadowEncounter` 独立绘制。
