...
- `废弃楼层/近景/1.png`（2560×1440）、`近景/2.png`（1920×1080）：两张透明全屏近景图按 1、2 顺序左右拼接；第一张缩放到 1920×1080，与第二张组成每间房 3840×1080 的完整地图，不在单间房内循环平铺。两张图的纵向偏移分别由 `CORRIDOR_LAYOUT.nearSegmentYOffsets.one/two` 微调，整体地面对齐值由 `nearTop` 控制。
