...
export interface TownStore extends CurioTownSlice {
  ...
  refreshShop: import("../townSlices/shopSlice").ShopSlice["refreshShop"];
  buyShopSlot: import("../townSlices/shopSlice").ShopSlice["buyShopSlot"];
  upgradeShop: import("../townSlices/shopSlice").ShopSlice["upgradeShop"];
  researchTech: import("../townSlices/techTreeSlice").TechTreeSlice["researchTech"];
  ...
  rollReforge: import("../townSlices/equipCraftSlice").EquipCraftSlice["rollReforge"];
  applyReforge: import("../townSlices/equipCraftSlice").EquipCraftSlice["applyReforge"];
}
